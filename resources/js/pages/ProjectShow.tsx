...
function ImageModal({ 
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-4 right-4 px-3 py-1 bg-black/50 rounded text-white/60 text-sm font-mono">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        {project.features.map((feature, index) => (
                                            <motion.div
                                                ...
                                                className="p-4 rounded-xl border border-white/10 bg-white/5 hover:border-purple-500/30 transition-colors"
                                            >
                                                {feature.icon && (
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                        {project.metrics.map((metric, index) => (
                                            ...
                                            >
                                                ...
                                                <div className="text-sm text-white/60 mt-1">{metric.name}</div>
                                                {metric.description && (
                                                    <div className="text-xs text-white/40 mt-1">{metric.description}</div>
                                                )}
                                            </motion.div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                        {project.images.map((image, index) => (
                                            <motion.button
                                                ...
                                                className="aspect-video rounded-lg overflow-hidden border border-white/10 hover:border-cyan-500/50 transition-colors group"
                                            >
                                                <img
                                                    src={image.image_url}
                            ...
                            {project.videos.length > 0 && (
                                ...
                                >
                                    <h2 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
                                        <span className="w-8 h-[2px] bg-red-400" />
                                        Demo Videos
                                    </h2>
                                    <div className="space-y-4">
                                        {project.videos.map((video) => (
                                            <div key={video.id} className="rounded-xl overflow-hidden border border-white/10">
                                                <div className="aspect-video">
                                                    {video.embed_url ? (
                                                        ...
                                                        <a
                                                            ...
                                                            className="flex items-center justify-center h-full w-full bg-white/5 hover:bg-white/10 transition-colors"
                                                        >
                                                            <span className="text-white/60">Watch: {video.title}</span>
                                                        </a>
                                                    )}
                                                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <GlassCard className="p-6">
                                    ...
                                    {project.role && (
                                        <div className="mb-6">
                                            <h3 className="text-xs font-mono uppercase text-white/40 mb-1">Role</h3>
                                    ...
                                    {project.dataset_used && (
                                        <div className="mb-6">
                                            <h3 className="text-xs font-mono uppercase text-white/40 mb-1">Dataset</h3>
                                            <p className="text-white/80">{project.dataset_used}</p>
                                        </div>
                                    )}
                                    ...
                                    {project.tech_stack.length > 0 && (
                                        <div className="mb-6">
                                            <h3 className="text-xs font-mono uppercase text-white/40 mb-2">Tech Stack</h3>
                                            <div className="flex flex-wrap gap-2">
                                                {project.tech_stack.map((tech) => (
                                                    <span
                                                        key={tech}
                                                        className="px-2 py-1 text-xs font-mono text-white/70 bg-white/5 rounded border border-white/10"
                                                    >
                                                        {tech}
                                                    </span>
                                                ))}
                                    ...
                                    {project.tags.length > 0 && (
                                        <div className="mb-6">
                                            <h3 className="text-xs font-mono uppercase text-white/40 mb-2">Tags</h3>
                                            <div className="flex flex-wrap gap-2">
                                    ...
                                    <div className="space-y-3 pt-6 border-t border-white/10">
                                        {project.github_url && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center gap-3 px-4 py-3 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-colors text-white/80 hover:text-white"
                                            >
                            ...
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {relatedProjects.map((related, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="rounded-xl border border-white/10 overflow-hidden hover:border-cyan-500/30 transition-colors">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <h3 className="font-semibold text-white group-hover:text-cyan-400 transition-colors mt-1">
                                                        {related.title}
                                                    </h3>
